...
CLASS_NAMES_origin = [
    "aeroplane", "bicycle", "BulletTrain",  "boat", "bottle", "Pedestrian",  "car", "cat",
    "chair", "RailwayStraight", "diningtable", "dog", "horse", "RailwayLeft", "person",
    "pottedplant", "sheep", "RailwayRight",  "train", "tvmonitor", "Helmet","Spanner",
]
...
CLASS_NAMES_split1 = [
    'aeroplane', 'bicycle', 'boat', 'bottle', 'car', 'cat', 'chair',
    'diningtable', 'dog', 'horse', 'person', 'pottedplant', 'sheep',
    'train', 'tvmonitor', "BulletTrain", "Pedestrian", "RailwayStraight",
...
CLASS_NAMES_split4 = [
    "aeroplane", "bicycle", "bird", "boat", "bottle",   "chair",
    "diningtable", "pottedplant",  "sofa",
...
def load_voc_instances(name: str, dirname: str, split: str):
    ...
    for fileid in fileids:
        ...
        for obj in tree.findall("object"):
            ...
            bbox[0] -= 1.0
            bbox[1] -= 1.0
            # if cls not in CLASS_NAMES_split4:
            #     continue
            instances.append(

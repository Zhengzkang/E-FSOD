...
def parse_args(in_args=None):
    ...
    parser.add_argument("--config-file", default="configs/PascalVOC-Detection/faster_rcnn_R_101_FPN_ours_split1_30shot.yaml", metavar="FILE", help="path to config file")

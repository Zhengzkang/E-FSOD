...
def parse_args():
    ...
    # Paths
    parser.add_argument('--src1', type=str, default='/home/yetao/zzk/few_shot/Efficient-FSOD/Output/FPN/base_Retina_FPN/model_final.pth',
    ...
    parser.add_argument('--save-dir', type=str, default='checkpoints/voc/faster_rcnn/faster_rcnn_R_101_FPN_all1',
                        help='Save directory')
    # Surgery method
